...
| ファイル | 名前 | 遷移元 |
|---------|------|--------|
| slide.html | すべりだいめいろ | おせわごっこ → こうえん |
| swing.html | ブランコ | おせわごっこ → こうえん |
| tebiki.html | つかいかたせつめい | 直接URL |
...
|---|------|---------|
| 0 | はだし | なし（デフォルト） |
| 1 | ピンクくつ | doll_pinkshoes.png |
| 2 | スニーカー | doll_sneakers.png |
| 3 | ブーツ | doll_boots.png |
